...
?>
<?php if (is_contato()): ?>
<p><img src="images/img-contato.jpg" alt="Masterbatch" /><br/></p>
...
<br /></p>
<p><strong>Email Gerencia:</strong><br />
<?php echo "<a href='mailto:".$site->site[email]."'>".$site->site[email]."</a>"; ?>
</p>
<p><strong>Email Vendas:</strong><br />
<?php echo "<a href='mailto:".$site->site[email_secundario]."'>".$site->site[email_secundario]."</a>"; ?>
</p>
<?php endif ?>
...
<a href="mailto:tania.comercial@smex.com.br">tania.comercial@smex.com.br</a><br/>
<a href="mailto:vendas@smex.com.br">vendas@smex.com.br</a><br/>
</p>
<p><strong>Informações Técnicas:</strong><br />
<a href="mailto:smex@smex.com.br">smex@smex.com.br</a><br/>
</p>
<?php endif; ?>
</div>
